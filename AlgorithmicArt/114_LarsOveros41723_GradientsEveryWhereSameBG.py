...
def Draw():
    ...
    title = "Gradient Triangles and Squares and Circles Randomly Same Background"
    ...
    for i in range(0,num):
        ...
        if shape == 0:
            drawGradientSquare(turtle, x, y, cellsize, number, bg, color2)
        elif shape == 1:
            drawGradientTriangle(turtle, x, y, cellsize, number, bg, color2)
        elif shape == 2:
