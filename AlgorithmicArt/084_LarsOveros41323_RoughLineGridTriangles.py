...
def Draw():
    ...
    for col in range(0, numCols):
        for row in range(0, numRows):
            ...
            turtle.pensize(pensize)
            turtle.begin_fill()
            drawWobblyLine(turtle, x, y, x, y + cellSize)
            drawWobblyLine(turtle, x, y + cellSize, x + cellSize, y + cellSize)
            drawWobblyLine(turtle, x + cellSize, y + cellSize, x + cellSize, y)
            ...
            turtle.color("black")
            offset = 15
            drawWobblyLine(turtle, x + offset, y + offset, x + cellSize//2 , y+ cellSize - offset)
            drawWobblyLine(turtle, x + cellSize // 2, y + cellSize - offset, x + cellSize - offset, y + offset)
            drawWobblyLine(turtle, x + cellSize - offset, y + offset, x+ offset, y+ offset)
