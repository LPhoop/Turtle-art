...
def Draw():
    ...
    for row in range (0,numRows):
        for col in range(0,numCols):
            ...
            drawConcentricCircle(turtle, x, y, radius/1.5, number, colors, extent=extent, start=start)


            drawConcentricCircle(turtle, x, y, radius/2, number, colors, extent=extent, start=start)

            drawConcentricCircle(turtle, x, y, radius/4, number, colors, extent=extent, start=start)
