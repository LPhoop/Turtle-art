...
def drawCircles():
    ...
    for row in range(0, numRows):
        for col in range(0, numCols):
            ...
            turtle.pendown()
            # turtle.begin_fill()
            radius = random.randint(cellSize//4, cellSize//2)
            drawCircle(turtle, x, y, radius, lineWidth=6, extent=random.randint(5, 360), start=random.randint(0,360))
            turtle.color(random.choice(colors))
            drawCircle(turtle, x, y, radius//3, lineWidth=4, extent=random.randint(5, 360), start=random.randint(0, 360))
            turtle.color(random.choice(colors))
            drawCircle(turtle, x, y, radius//2, lineWidth=4, extent=random.randint(5, 360), start=random.randint(0,360))
            # turtle.end_fill()
