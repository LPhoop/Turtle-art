...
def Draw():
    ...
    title = "Polygons Randomly Placed (gradient)"
    ...
    for num in range(number):
        ...
        if (color2 == color1):
            while (color2 == color1):
                color1 = random.choice(colors)
        drawGradientPolygon(turtle, x,y,length,number,color1,color2)
    ...
    #         drawGradientPolygon(turtle, x + 10,y,newRad,number, color2, color1)
    #         turtle.penup()
    #         turtle.color()
    #         colors = randomPalette()
